...
namespace Config
{
    ...
    bool Save(const std::wstring& name, const VisualSettings& settings, const RuntimeSettings& runtime)
    {
        ...
        WriteColour(file, L"healthText", settings.healthTextColour);
        WriteColour(file, L"name", settings.nameColour);
        WriteColour(file, L"distance", settings.distanceColour);
        WriteColour(file, L"weapon", settings.weaponColour);
        ...
        WriteColour(file, L"visibleCheck", settings.visibleCheckColour);
        WriteColour(file, L"teamCheck", settings.teamCheckColour);
    ...
    bool Load(const std::wstring& name, VisualSettings& settings, bool& particlesEnabled, float& particleSpeed, float& particleAmount)
    {
        ...
        while (std::getline(file, line))
        {
            ...
            try
            {
                ...
                else if (key == L"healthTextR") settings.healthTextColour.r = floatValue;
                else if (key == L"healthTextG") settings.healthTextColour.g = floatValue;
                else if (key == L"healthTextB") settings.healthTextColour.b = floatValue;
                else if (key == L"nameR") settings.nameColour.r = floatValue;
                else if (key == L"nameG") settings.nameColour.g = floatValue;
                else if (key == L"nameB") settings.nameColour.b = floatValue;
                else if (key == L"distanceR") settings.distanceColour.r = floatValue;
                else if (key == L"distanceG") settings.distanceColour.g = floatValue;
                else if (key == L"distanceB") settings.distanceColour.b = floatValue;
                else if (key == L"weaponR") settings.weaponColour.r = floatValue;
                else if (key == L"weaponG") settings.weaponColour.g = floatValue;
                else if (key == L"weaponB") settings.weaponColour.b = floatValue;
                ...
                else if (key == L"visibleCheckR") settings.visibleCheckColour.r = floatValue;
                else if (key == L"visibleCheckG") settings.visibleCheckColour.g = floatValue;
                else if (key == L"visibleCheckB") settings.visibleCheckColour.b = floatValue;
                else if (key == L"teamCheckR") settings.teamCheckColour.r = floatValue;
                else if (key == L"teamCheckG") settings.teamCheckColour.g = floatValue;
                else if (key == L"teamCheckB") settings.teamCheckColour.b = floatValue;
